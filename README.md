...
| Feature | Jindal Steel (Load Site) | Shinas Solar Plant (Generator Site) |
|---|---|---|
...
> **Note:** Codebase is under active development. The directory structure above reflects the planned architecture.
